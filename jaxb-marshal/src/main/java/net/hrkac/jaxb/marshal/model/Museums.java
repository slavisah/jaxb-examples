...
public class Museums {
    ...
    /**
     * This method is not used by jaxb, just used for business reasons. In the
     * case that this class would be generated using xml schemas definitions,
     * this method has to be added to the generated class or to some helper or
     * util one
     * 
     * @param museum
     */
